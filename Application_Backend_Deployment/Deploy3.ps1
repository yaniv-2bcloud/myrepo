...
$storageAccountName = "contosoretailstorage"
$cosmosDBName = "contosoretailstorage"
$resourceGroupName = "contosoretail"
$serviceEndpoint = "contoso09192894.westus2.cloudapp.azure.com"

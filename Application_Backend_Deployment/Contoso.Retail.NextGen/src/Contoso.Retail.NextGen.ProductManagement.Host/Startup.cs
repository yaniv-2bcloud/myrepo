...
namespace Contoso.Retail.NextGen.ProductManagement.Host
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Contoso Retail's Product Management Service API Endpoint", Version = "v1" });
